...
class Side_Slip_Angle_Estimation(object):
    def __init__(self):
        ...
        self.process_noise_v_kd = np.array([[0.01],
                                            [0.01]])

        self.sensor_noise_w_kd = np.array([[0.05],
                                           [0.05]])

        self.Q_kd = np.array([[0.05, 0],
                              [0, 0.05]])

        self.R_kd = np.array([[0.1, 0],
                              [0, 0.1]])
        ...
        self.sensor_noise_w_kk = np.array([[0.01],
                                           [0.01]])

        self.Q_kk = np.array([[0.01, 0],
                              [0, 0.01]])

        self.R_kk = np.array([[0.01, 0],
                              [0, 0.01]])
    ...
    def get_kinematics_param(self, data, Delta_T):
        ...
        A_k12 = Delta_T * yaw_rate - (Delta_T ** 3 * yaw_rate ** 3) / 6
        A_k21 = (Delta_T ** 3 * yaw_rate ** 3) / 6 - Delta_T * yaw_rate
